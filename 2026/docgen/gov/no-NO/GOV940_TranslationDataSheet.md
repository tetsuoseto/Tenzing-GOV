...
###@ Machine Translation
Machine translation language: no-NO
...
Archive status: Preview
  [Archive URL](https://github.com/tetsuoseto/Tenzing-Arxiv/blob/main/iaisr/docgen/gov/no-NO/baseline/GOVAll_no-NO.pdf)
QR code:
![qrcode](images/qrcode_gov_no-NO.png)
